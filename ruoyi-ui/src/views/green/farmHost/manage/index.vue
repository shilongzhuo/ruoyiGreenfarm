<template>
  <div style="width: 80%;margin-left: 10%;margin-top: 30px">
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button type="danger" @click="handleDelete(scope.$index, scope.row)">
            下架<i class="el-icon-delete2 el-icon--right"></i>
          </el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <div style="width: 20%;margin-left: 40%">
      <el-button type="success" style="float: right" @click="sub_order">添加新商品</el-button>
    </div>
  </div>
</template>
...
export default{
  ...
  methods: {
    sub_order(){
      this.$router.push({path:'item',query: {id:"1"}})    //跳转
    },
